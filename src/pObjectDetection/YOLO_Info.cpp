...
#include <cstdlib>
#include <iostream>
#include "ObjectDetection_Info.h"
...
void showSynopsis()
{
  blk("SYNOPSIS:                                                       ");
  blk("------------------------------------                            ");
  blk("  The pObjectDetection application is used as an abstract object detection integrater to moos.  ");
...
void showHelpAndExit()
{
  ...
  mag("  --version,-v                                                  ");
  blk("      Display the release version of pObjectDetection.        ");
  blk("                                                                ");
